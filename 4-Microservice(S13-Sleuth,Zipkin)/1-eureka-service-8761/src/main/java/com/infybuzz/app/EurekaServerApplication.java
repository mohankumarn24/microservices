...
/*
http://localhost:8761/
http://localhost:9090/student-service/api/student/getById/1   [Note: Need to configure routes spearately, if we need url like http://localhost:9090/api/student/getById/1]
